...
$region = "eastus"
$username = "itadmin" #username for the VM
...
$Params = @{
    ...
    Settings          = @{fileUris = @('https://raw.githubusercontent.com/mustafa99988/It-Giants/main/GatewayTransit/configureSpoke1.sh'); commandToExecute = './configureSpoke1.sh'}
}
...
$Params = @{
    ...
    ExtensionType      = 'CustomScript'
    TypeHandlerVersion = '2.1'
    Settings          = @{fileUris = @('https://raw.githubusercontent.com/mustafa99988/It-Giants/main/GatewayTransit/configureSpoke2.sh'); commandToExecute = './configureSpoke2.sh'}
}
